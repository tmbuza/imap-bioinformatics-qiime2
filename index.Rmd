...
A detailed interactive snakemake HTML report is available [here](https://complexdatainsights.com/imap/imap-bioinformatics-qiime2/report.html). Use a wider screen to get a better interactive snakemake report.


<br>

```{r child='workflow/scripts/01_qiime2_getting_started.Rmd', eval=FALSE}
```

<br>

```{r child='workflow/scripts/02_qiime2_seq_clustering.Rmd', eval=FALSE}
```

<br>

```{r child='workflow/scripts/03_qiime2_process.Rmd', eval=FALSE}
```

<br>

## Decontaminated reads
[Interactive histograms.](qiime2_process/interactive1/overview.html)

<br>

[Interactive plot for read quality control.](qiime2_process/interactive1/quality-plot.html)


<br>

## Decontaminated reads subsampled at 15%
[Interactive histograms.](qiime2_process/interactive2/overview.html)

<br>

[Interactive plot for read quality control.](qiime2_process/interactive2/quality-plot.html)


<br>

## Tree clusters
[Community interactive tree with index.html](qiime2_process/tree_interactive/index.html)

<br>

[Community interactive tree with empress.html](qiime2_process/tree_interactive/index.html)


<br>

[Rarefaction interactive report](qiime2_process/rarefy_interactive/index.html)

---
title:  "<big><u>IMAP-PART 05</u></big><br><br>Microbial profiling using QIIME2 pipeline with Snakemake workflows<br><br>"
subtitle: |
  | ![](images/16srrna.png)<br>
  | Fostering Reproducible Microbiome data Analysis with Snakemake workflow
date:
- IMAP-PART 05<br>[Latest GitHub-Repo](https://github.com/tmbuza/imap-bioinformatics-qiime2/)<br>
